...
public class AppDAO {
	...
	public static String getUserStatusByID(String userName)
	{
		String status="";
	...
	public static Reports getReportsByid(int pid)
	{
		Reports reports=new Reports();

		try {

			PreparedStatement ps=MyConnection.getConnection().prepareStatement("select * from reports where reportid='"+pid+"'");
	...
	public static int addAccess(String patient,String hospital)
	{
		int result=0; 

		try {
			
			PreparedStatement ps=MyConnection.getConnection().prepareStatement("insert into patientaccess values(?,?,?)");
	...
	public static int deleteAccess(String patient,String hospital)
	{
		int result=0; 

		try {
			
			PreparedStatement ps=MyConnection.getConnection().prepareStatement("delete from patientaccess where patientid='"+patient+"' and hospitalid='"+hospital+"'");
	...
	public static List<String> getAccess(String patient)
	{
		List<String> accessList=new ArrayList<String>();

		try {

			PreparedStatement ps=MyConnection.getConnection().prepareStatement("select * from patientaccess where patientid='"+patient+"'");

			ResultSet rs=ps.executeQuery();

			while (rs.next()) {

				accessList.add(rs.getString(3));
			}
	...
	public static List<String> getMyPatients(String hospitalName)
	{
		List<String> accessList=new ArrayList<String>();

		try {

			PreparedStatement ps=MyConnection.getConnection().prepareStatement("select * from patientaccess where hospitalid='"+hospitalName+"'");

			ResultSet rs=ps.executeQuery();

			while (rs.next()) {

				accessList.add(rs.getString(2));
			}
