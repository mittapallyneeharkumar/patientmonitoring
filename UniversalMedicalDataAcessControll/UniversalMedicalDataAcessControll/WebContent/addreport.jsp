...
<body>
	<div id="main">
		...
		<div id="site_content">
			...
			<form action="AddReportsServlets" name="ff" method="post"
				...
				<div class="form_settings">
					...
					<p>
						<span>ReportName</span><input type="text" name="reportname" />
					</p>
					...
					<p>
						<span>Upload Report Here</span><input type="file" name="report">
					</p>
