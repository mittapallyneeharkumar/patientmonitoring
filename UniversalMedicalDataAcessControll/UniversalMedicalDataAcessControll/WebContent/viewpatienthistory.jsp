			...
			<div id="menubar">
				<ul id="menu">
					...
					<li class="hvr-sweep-to-bottom"><a
						href="viewpatienthistory.jsp">Search Patient</a></li>
			...
			<div id="content">
				...
				<form action="viewpatienthistory.jsp" name="ff"
					...
					<div class="form_settings">
						...
						<p>
							<span>Enter Patient Aadhar ID</span><input type="text"
								name="patientname" />
						</p>
				...
				<%
					...
					if (patientName != null) {
						...
						List<String> patients = AppDAO.getMyPatients((String) request.getSession().getAttribute("username"));

						if (patients.contains(patientName)) {
							
							List<Reports> reports = AppDAO.getReportsByPatient(patientName);

							CurrentStatusForm currentStatus = AppDAO.getCurrentStatusFormByid(patientName);

							List<DailyForm> dailyForms = AppDAO.getDailyFormByPatient(patientName);

							List<SurgaryForm> surgaryForms = AppDAO.getSurgaryFormByPatient(patientName);

							List<DischargeForm> dischargeForms = AppDAO.getDischargeFormByPatient(patientName);
				%>

				<h1>Current Status</h1>
				<table class="imagetable" align="center">
					<%
						if(currentStatus.getCurrentStatus()!=null)
						{
					%>
							<tr>
				...
				<table class="imagetable">
					...
					<tr>
						...
						<td><a href="DownloadServlet?file=<%=report.getFileName()%>">download</a></td>
					</tr>
					<%
						}
					%>
