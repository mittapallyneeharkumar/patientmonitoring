	...
	<div id="main">
		<div id="header">
			<div id="logo">
				...
				<div class="slogan"> <font color="white" size="5">Patient Monitoring System </font> </div>
			</div>
			<div id="menubar">
				<ul id="menu">
		...
		<div id="site_content">
			...
			<div id="content">
				...
				<%		
					...
					{
				%>
					 <h1>Add Daily Medicine</h1>
				<%		
					}
				%>
				
			<form action="AddDialyMedisineServlet" name="ff" method="post"
				...
				<div class="form_settings">
					...
					<p>
						<span>Doctor</span><input type="text" name="doctorname"/>
					</p>

					<p>
						<span>Morning</span><input type="text" name="morning" />
					</p>
					
					<p>
						<span>Afternoon</span><input type="text" name="afternoon" />
					</p>
					
					<p>
						<span>Night</span><input type="text" name="night" />
					</p>
